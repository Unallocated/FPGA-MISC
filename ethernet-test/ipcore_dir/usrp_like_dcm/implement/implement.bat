...
xst -ifn xst.scr
move usrp_like_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\usrp_like_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc usrp_like_dcm_exdes.ucf usrp_like_dcm_exdes

echo 'Running map'
map -timing -pr b usrp_like_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm usrp_like_dcm_exdes -w routed.ncd routed.vhd
cd ..
