...
xst -ifn xst.scr
move packet_capture_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\packet_capture_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc packet_capture_dcm_exdes.ucf packet_capture_dcm_exdes

echo 'Running map'
map -timing -pr b packet_capture_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm packet_capture_dcm_exdes -w routed.ncd routed.vhd
cd ..
