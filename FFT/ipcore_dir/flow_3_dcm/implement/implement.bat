...
xst -ifn xst.scr
move flow_3_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\flow_3_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc flow_3_dcm_exdes.ucf flow_3_dcm_exdes

echo 'Running map'
map -timing -pr b flow_3_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm flow_3_dcm_exdes -w routed.ncd routed.vhd
cd ..
