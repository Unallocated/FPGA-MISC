...
xst -ifn xst.scr
move phase_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\phase_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc phase_gen_exdes.ucf phase_gen_exdes

echo 'Running map'
map -timing -pr b phase_gen_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm phase_gen_exdes -w routed.ncd routed.vhd
cd ..
