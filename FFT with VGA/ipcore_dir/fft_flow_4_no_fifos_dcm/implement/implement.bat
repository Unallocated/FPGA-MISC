...
xst -ifn xst.scr
move fft_flow_4_no_fifos_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\fft_flow_4_no_fifos_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc fft_flow_4_no_fifos_dcm_exdes.ucf fft_flow_4_no_fifos_dcm_exdes

echo 'Running map'
map -timing -pr b fft_flow_4_no_fifos_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm fft_flow_4_no_fifos_dcm_exdes -w routed.ncd routed.vhd
cd ..
