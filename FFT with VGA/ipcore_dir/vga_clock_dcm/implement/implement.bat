...
xst -ifn xst.scr
move vga_clock_dcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\vga_clock_dcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc vga_clock_dcm_exdes.ucf vga_clock_dcm_exdes

echo 'Running map'
map -timing -pr b vga_clock_dcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm vga_clock_dcm_exdes -w routed.ncd routed.vhd
cd ..
