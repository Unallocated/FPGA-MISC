...
xst -ifn xst.scr
move clock_mgr_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_mgr_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_mgr_exdes.ucf clock_mgr_exdes

echo 'Running map'
map -timing -pr b clock_mgr_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clock_mgr_exdes -w routed.ncd routed.vhd
cd ..
